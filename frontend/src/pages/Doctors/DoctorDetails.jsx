                ...
                leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded">
                  ...
                  lg:leading-7 font-semibold text-textColor">
								...
								<p className="text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]">
									...
									pariatur laudantium harum at earum ipsam quod similique, nemo
									consequatur ex rem magni ad vero iure placeat doloremque
									quisquam esse dicta.
								</p>
							</div>
						</div>
						...
						<div className="mt-[50px] border-b border-solid border-[#0066ff34]">
							<button
								...
								} py-5 px-5 mr-5 text-[16px] leading-7 text-headingColor font-semibold`}>
								About
							</button>
							<button
