							...
							<div>
								<div className="lg:w-[570px]">
									...
									<p className="text__para">
										...
										Doloremque inventore qui aspernatur animi eligendi! Ipsam,
										architecto voluptates provident aut enim repudiandae ut
										excepturi dignissimos ipsum impedit sunt esse in quam.
									</p>
								...
								<div className="mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-[30px]">
									<div>
										...
										<span className="w-[100px] h-2 bg-yellow-200 rounded-full block mt-[-14]"></span>
									...
									<div>
										...
										<span className="w-[100px] h-2 bg-blue-400 rounded-full block mt-[-14]"></span>
								...
								<div className="py-[30px] px-5">
									...
									<div className="mt-[30px]">
										...
										<p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
											Lorem ipsum dolor sit, amet consectetur adipisicing elit.
											Minima delectus in accusantium repudiandae!
										</p>
										<Link
											to="/doctors"
							...
							<div className="xl:w-[670px]">
								...
								<ul className="pl-4">
									<li className="text__para">
										1. Sechedule the appointment directly.
									</li>
									<li className="text__para">
							...
							<div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
								...
								md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
									<div className="flex items-center justify-between">
										...
										bg-yellow-500 rounded py-1 px-[6px] lg:py-3 lg:px-[9px]">
